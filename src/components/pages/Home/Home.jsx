    ...
    <div className="overflow-hidden">
      <div className="">
        <div className="px-[15px] py-[35px] w-full flex">
          {/* Sidebar */}
          <div className="w-[186px] h-[954px] bg-[#5F35F5] rounded-[20px] flex-shrink-0 relative">
            <div className="pl-[42px] pt-[38px] ">
              <div className="group relative cursor-pointer">
                <img src={profile} alt="" />
                <div className="w-[100px] h-[100px] group-hover:opacity-[0.8] bg-black transition duration-150 absolute top-0 mt-[0px] opacity-0 rounded-full flex justify-center items-center">
                  <GrCloudUpload
                    onClick={handleClick}
        ...
        hover:text-[#5F35F5] hover:rounded-[12px] p-[10px]"
          ...
          {show && (
  <div className="absolute bottom-4 left-0 top-0 z-[9999] w-full h-full bg-red-500  text-black text-center rounded-lg p-4 shadow-lg">
      ...
      <div className="bg-white w-[600px] py-5 px-8 rounded shadow-lg">
        ...
        <div className="flex  gap-4 mt-6">
            <button
              ...
              className="bg-[#5F34F5] text-white  w-[120px] h-[50px] rounded-lg hover:bg-blue-700 transition duration-300"
            >
              Upload
            </button>
            ...
            <button
              ...
              className="bg-gray-500 text-white w-[120px] h-[50px] rounded-lg hover:bg-gray-600 transition duration-300"
            >
              Back to Login
            </button>
          </div>
